...
\begin{enumerate}
    ...
    \item \textbf{Ejecución y Visualización (CE.e):} Capturas de pantalla demostrando la correcta ejecución de las consultas solicitadas en la Fase 3. Puedes usar tanto la consola de \textbf{DataGrip} como las interfaces visuales de cada contenedor (\textbf{RedisInsight, Mongo Express o Neo4j Browser}) donde se vea claramente el código introducido y el resultado devuelto.
\end{enumerate}
