...
\begin{frame}
  ...
  \vspace{0.5em}
  \textbf{Solución 1: Tabla Normalizada}
  \begin{center}
    \resizebox{\textwidth}{!}{
    \begin{tabular}{llllllll}
      \toprule
...
% ============================
\begin{frame}
  \frametitle{Solución 2: Tablas Normalizadas}
...
\frametitle{Ejercicio: ¿Está en 2FN?}
  ...
  \textbf{2. Tabla PED\_ART} (Desglose de artículos de un pedido)
  \begin{center}
  \resizebox{0.9\textwidth}{!}{
    \begin{tabular}{llllll}
      \toprule
...
\begin{frame}
  ...
  \vspace{0.5em}
  \small{\textbf{Problema:} Aunque la Provincia está relacionada con el Cliente (DNI\_CL $\to$ Provincia), en realidad depende directamente del Código Postal (DNI\_CL $\to$ C\_POS $\to$ PROV.)}
\end{frame}
