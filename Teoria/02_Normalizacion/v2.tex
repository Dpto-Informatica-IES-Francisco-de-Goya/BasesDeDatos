...
\begin{frame}
  \frametitle{Problemas de un mal diseño}
...
\begin{frame}
  \frametitle{Ejemplo: Préstamos de Biblioteca}
...
\begin{frame}
  ...
  \begin{exampleblock}{Ejemplo: Notas de Alumnos}
    Dada la tabla: \texttt{NOTAS(NT\_ASIG, NT\_ALUM, NT\_NOT)}
    \begin{itemize}
        \item La nota (\texttt{NT\_NOT}) depende de la combinación (Asignatura + Alumno).
        \item Un solo valor de esta pareja define la nota.
    \end{itemize}
  \end{exampleblock}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \begin{tabular}{llllllll}
      ...
      \midrule
      123 & 19/11 & C14 & Pepe & A03,A15,A01 & 24,10,100 & Lápiz,Goma & 25,15 \\
      145 & 24/11 & C67 & Juan & A02,A15,A24 & 1000,10,30 & Folio,Goma & 1,15 \\
      \bottomrule
    \end{tabular}
    }
  \end{center}
...
\begin{frame}
  ...
  \vspace{0.5em}
  \small{\textbf{Problema:} Aunque la Provincia está relacionada con el Cliente, en realidad depende directamente del Código Postal.}
\end{frame}
...
\begin{frame}
  ...
  Debemos romper esta cadena separando los datos del Código Postal y Provincia.
\end{frame}
